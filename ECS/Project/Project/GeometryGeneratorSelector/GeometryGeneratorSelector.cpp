...
{
	std::string icosphereDetailLevelString = "None";
	int icosphereDetailLevel = 1;

	if (newResourceDescription.findProperty("Icosphere Detail Level", icosphereDetailLevelString))
	{
		icosphereDetailLevel = std::stoi(icosphereDetailLevelString);
	}


	std::string icosphereRoughnessLevelString = "None";
	int icosphereRoughnessLevel = 1;
	if (newResourceDescription.findProperty("Icosphere Roughness Level", icosphereRoughnessLevelString))
	{
		icosphereRoughnessLevel = std::stoi(icosphereRoughnessLevelString);
	}

	Icosphere icosphere(icosphereDetailLevel, icosphereRoughnessLevel);
...
{
	std::string planetRingDivisionsString = "None";
	int planetRingDivisions = 20;

	if (newResourceDescription.findProperty("Planet Ring Divisions", planetRingDivisionsString))
	{
		planetRingDivisions = std::stoi(planetRingDivisionsString);
	}

	PlanetRing planetRing(planetRingDivisions);
